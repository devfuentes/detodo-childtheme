  ...
  <div class="user-info">
            ...
            <li>
              <div class="account-link account">
                <a
                  ...
                  rel="nofollow"
                >
                  <i class="material-icons">person</i> {$customerName}
                </a>
              </div>
    ...
    {else}
      <div class="js-account-source">
        ...
        <li>
            <div class="account-link account-link--noborder">
              <a
                href="index.php?controller=authentication&create_account=1"
                title="{l s='Create account' d='Shop.Theme.Customeraccount'}"
                rel="nofollow"
              >
          ...
          <li>
            <div class="account-link account-link--noborder link-bold">
              <a
                href="{$my_account_url}"
