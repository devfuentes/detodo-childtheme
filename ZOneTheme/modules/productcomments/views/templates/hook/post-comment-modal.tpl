              ...
              <div class="row">
                {if $product.cover}
                  <div class="col-2 product-image">
                    <img class="img-fluid" src="{$product.cover.small.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}"/>
                  </div>
                {/if} 
                <div class="col-10 product-infos">
                  <h5 class="product-name pt-0">{$product.name}</h5>
                  <div>{$product.description_short|strip_tags:false}</div>
                </div>
              </div>
            </div>
          {/if}
