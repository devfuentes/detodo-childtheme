 ...
 *}
<article class="product-miniature product-simple" data-id-product="{$product.id_product}" data-product-id-category="{$product.id_category_default}" data-product-id-manufacturer="{$product.id_manufacturer}">
