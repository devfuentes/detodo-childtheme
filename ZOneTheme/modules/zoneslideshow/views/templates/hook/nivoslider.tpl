...
<div class="aone-slideshow theme-default {if isset($settings.layout) && $settings.layout == 'boxed'}container{/if}">
  <div class="nivo-slider-overlay" id="js-nivoSliderOverlay">
    ...
    <img class="img-fluid" src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20{$firstSlide.image_width}%20{$firstSlide.image_height}%22%3E%3C/svg%3E" width="{$firstSlide.image_width}" height="{$firstSlide.image_height}" alt="">
  </div>

  <div id="aoneSlider" class="nivoSlider caption-effect-{$settings.caption_effect}" data-settings={$settings|json_encode}>
