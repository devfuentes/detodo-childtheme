...
<li class="cart-product-line">
  ...
  <div class="product-infos">
    ...
    <span class="product-attributes">{', '|implode:$product.attributes}</span>
    <span class="product-price-quantity">
      ...
      <span class="product-price">{$product.price}</span><span class="x-character">x</span><span class="product-qty">{$product.quantity}</span>
    </span>
  </div>
  <a
