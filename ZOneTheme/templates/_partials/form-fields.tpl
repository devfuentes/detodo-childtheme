...
{else}
  ...
  <div class="form-group row {$field.name} {if !empty($field.errors)}has-error{/if}">
    <label class="col-12 col-lg-3 form-control-label{if $field.required} required{/if}{if $field.type == 'checkbox'} d-none d-md-block{/if}">
      {if $field.type !== 'checkbox'}
        {$field.label}
      {/if}
    </label>
    <div class="col-12 {if in_array($field.type, ['radio-buttons', 'checkbox'])}col-lg-9{else}col-lg-6{/if}">
