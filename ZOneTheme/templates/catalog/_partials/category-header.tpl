  ...
  {if $listing.pagination.items_shown_from == 1}
    ...
    {if isset($cat_showDescription) && $cat_showDescription && $category.description}
      <div class="category-description mb-4">
        <div class="typo small-description {if isset($cat_expandDescription) && $cat_expandDescription}js-small-description{/if}" data-max-height="100">
          {$category.description nofilter}
        </div>
        <div class="description-expand js-expand-description">
          <a href="#">{l s='Show More' d='Shop.Zonetheme'} &nbsp;<i class="material-icons">trending_flat</i></a>
        </div>
      </div>
    {/if}
