    ...
    <div class="second-block">
      ...
      <div class="second-block-wrapper">
                ...
                <div class="product-price-and-shipping d-flex flex-wrap align-items-center" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                  ...
                  <div class="tax-shipping-delivery-label d-none">
                    {if $configuration.display_taxes_label}
                      <span class="aeuc_tax_label">{$product.labels.tax_long}</span>
                    {/if}
        ...
        <div class="buttons-sections">
          {if $product.add_to_cart_url && $product.customizable == 0}
          ...
          {block name='product_grid_buy'}
            <div class="grid-buy-button">
              {if $product.add_to_cart_url && $product.customizable == 0 && $product.minimal_quantity == 1}
                <a
